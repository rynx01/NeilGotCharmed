            ...
            <div id="carouselExampleIndicators" className="ngc-content-container carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img className="d-block w-100 ngc-images-slides-container" src={ './assets/wed1.jpg' } alt="First slide" />
                    </div>
                    <div className="carousel-item">
                        <img className="d-block w-100 ngc-images-slides-container" src={ './assets/wed2.jpg' } alt="Second slide" />
                    </div>
                    <div className="carousel-item">
                        <img className="d-block w-100 ngc-images-slides-container" src={ './assets/wed3.png' } alt="Third slide" />
                    </div>
              </div>
            </div>
        );
